$(function () {
    $(".num .sub").click(function () {
        ...
        if (c <= 1) {
            ...
            if($(this).siblings("span").attr('cartid')){
                var url = "IndexServlet?action=cart_numchange&count="+c+"&cart_id="+$(this).siblings("span").attr('cartid');
                $.get(url,function () {});
            }
    ...
    $(".del").click(function () {
        if ($(this).parent().parent().hasClass("th")) {
            $(".mask").show();
            $(".tipDel").show();
            var url = "IndexServlet?action=cart_del&cart_id="+$(this).attr('cartid')
            ...
            if ($(".th input[type='checkbox']:checked").length == 0) {
                ...
                var url="IndexServlet?action=manydelete&str="+str;
                $.get(url,function (data) {});
                $(".cer").click(function () {

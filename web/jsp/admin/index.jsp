...
<body>
	<div class="header container-fluid">
		<a class="title" href="jsp/admin/main.jsp" target="rFrame"> E-commerce backend management system</a>
		<div class="btn-group adminName">
			<button type="button" class="btn btn-default dropdown-toggle">
			    ${adminUser.username} <span class="caret"></span>
			</button>
			<ul class="dropdown-menu dropdown-menu-right">
			    <li><a href="LoginOutServlet" target="_top" onClick="return confirm('Confirm to 退出系统了么？')">Exit</a></li>
			</ul>
		</div>

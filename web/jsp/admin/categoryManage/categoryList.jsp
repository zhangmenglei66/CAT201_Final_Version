...
<div class="container-fulid content">
    <div class="funbtn">
        ...
        <a class="btn btn-info" href="jsp/admin/categoryManage/categoryAdd.jsp">Add primary category</a>
        <a class="btn btn-info" href="jsp/admin/CategoryManageServlet?action=categorytoadd">Add secondary category</a>
    </div>
                    ...
                    <tr>
                        ...
                        <td class="noClick">
                            <a class="btn btn-info btn-xs"
                               href="jsp/admin/CategoryManageServlet?action=edit&id=${i.id}">Edit</a>
...
<script type="text/javascript">
    ...
    $("#batDel").click(function () {
        ...
        if (confirm("Confirm to Delete" + choices.length + "条分类吗？")) {
